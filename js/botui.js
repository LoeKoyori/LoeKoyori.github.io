...
function bot_ui_ini() {
    ...
    var sure = function () {
                ...
                botui.message.add({
                    ...
                    botui.message.add({
                        ...
                        botui.message.add({
                            ...
                            botui.message.add({
                                delay: 1200,
                                content: "点了各种奇奇怪怪的科技树"
                            }).then(function () {
                                botui.message.add({
                                    delay: 1500,
                                    content: "比如法学、政治学、政治哲学"
                                }).then(function(){
                                    botui.message.add({
                                        delay: 1500,
                                        content: "计算机技术极菜"
                                        ...
                                        botui.message.add({
                                            delay: 1200,
                                            content: "曾学过古董Pascal语言，主攻卡西欧计算器平台（别笑）上的独立游戏开发(获利惊人地达到了两位数）"
                                        }).then(function(){
                                            botui.message.add({
                                                delay: 2800,
                                                content: "现在主要面向搜索引擎编程"
                                            }).then(function(){
                                                botui.message.add({
                                                    delay: 1500,
                                                    content: "知乎号被封后就只佛系地随便写写文章"
                                                }).then(function(){
                                                    botui.message.add({
                                                        delay: 1800,
                                                        content: "反正也不用抢热点（划掉）"
        ...
        fourthpart = function () {
            botui.message.add({
                delay: 1E3,
                content: "其实翻译成中文就是小代理 "
            }).then(function () {
                botui.message.add({
                    delay: 1100,
                    content: "设定上是代理我维护和管理网站的站主"
                }).then(function() {
                    botui.message.add({
                        delay: 1500,
                        content: "果然加上「小」就会萌一点！"
                    }).then(function () {
                        botui.action.button({
                            delay: 1500,
                            action: [{
                                text: "博客的域名有什么含意吗？(ง •_•)ง",
                                value: "why-domain"
                            }]
                        }).then(function (a) {
                            fifthpart()
        ...
        fifthpart = function () {
            botui.message.add({
                ...
                botui.message.add({
                    ...
                    botui.message.add({
                        delay: 1500,
                        content: '以上三个问题的详细回答见文章[Hello World](https://blogdemo.playmarxcards.online/1926/08/17/Hello%20World/)^'
                    }).then(function(){
                        botui.message.add({
                            delay: 1500,
                            content: "那么，仔细逛逛我的博客吧^_^"
                        })
                    })
                })
            })
